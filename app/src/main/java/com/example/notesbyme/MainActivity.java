        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            ...
            public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                ...
                new RecyclerViewSwipeDecorator.Builder(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                        .addBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.on_swiped_background))
                        .addActionIcon(R.drawable.ic_delete_black_24dp)
                        .addSwipeRightLabel("Swipe right to delete")
                        .create()
                        .decorate();
...
//            String lastUpdated = data.getStringExtra(AddEditNoteActivity.EXTRA_LAST_UPDATED);
    ...
    private void showSnackbarOnDelete(Note deletedNote) {
